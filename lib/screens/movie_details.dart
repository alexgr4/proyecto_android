...
Future<List<Cast>> fetchCasting(int id) async {
  final response = await http.get(Uri.parse(
      'https://api.themoviedb.org/3/movie/$id/credits?api_key=9ec3a5dc3d1c79366d75654dea61ebe3&language=en-US'));
...
Future<List<Streaming>> fetchStreaming(int id) async {
  final response = await http.get(Uri.parse(
      'https://api.themoviedb.org/3/movie/$id/watch/providers?api_key=9ec3a5dc3d1c79366d75654dea61ebe3'));
